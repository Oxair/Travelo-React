  ...
  return (
    <header className="white-80 tc pv4 header pb7 ">
      ...
      <nav className="bt bb tc center mt4 nav">
        ...
        <NavLink to='/travel-guide/africa' activeClassName="is-active" className="f6 f5-l link bg-animate white-80 hover-bg-red b dib pa3 ph4-l">Africa</NavLink>
        <NavLink to='/travel-guide/americas' activeClassName="is-active" className="f6 f5-l link bg-animate white-80 hover-bg-red b dib pa3 ph4-l">Americas</NavLink>
        <NavLink to='/travel-guide/asia' activeClassName="is-active" className="f6 f5-l link bg-animate white-80 hover-bg-red b dib pa3 ph4-l">Asia</NavLink>
